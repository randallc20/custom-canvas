...
At checkout you see, before paying:
...
Every piece states its medium, dimensions and — where relevant — whether it is an
...
**There is no automatic right of return.** Refunds are **artist-mediated**:

1. You request a refund from the artist in Messages, from your order.
...
If something has gone wrong, **talk to us before disputing the charge**. A chargeback
takes weeks, and we can usually resolve it faster. If you do dispute, we will respond
with the evidence we hold, including tracking and delivery records.

## 7. Cancellations

You may ask the artist to cancel before they ship. Once shipped, an order can only be
resolved as a refund under §5.
