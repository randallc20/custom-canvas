...
> registered agent there is **no §512(c) safe harbor**, and an infringing upload becomes
> Custom Canvas's liability rather than only the uploader's. Registration is **$6**
> through the Copyright Office's online directory (paper filings are no longer
> accepted) and **must be renewed every three years** or the safe harbor lapses.
> This policy is not effective until that registration exists.
...
6. A statement that the information in your notice is accurate, and **under penalty of
   perjury**, that you are the owner or authorised to act for the owner.
...
We remove or disable access to the material promptly, tell the artist what we removed
and why, and give them a copy of the notice.
...
If we receive a valid counter-notice we forward it to the complainant. Unless they tell
us they have filed a court action, we may restore the material in **10 to 14 business
days**.
