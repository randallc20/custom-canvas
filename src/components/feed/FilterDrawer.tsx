    ...
    <div className="fixed inset-0 z-50 md:hidden">
      ...
      <div className="fixed inset-x-0 bottom-0 max-h-[80vh] overflow-y-auto rounded-t-2xl bg-white p-6">
        <div className="mb-4 flex items-center justify-between">
          ...
          <button onClick={onClose} className="text-muted" aria-label="Close filters">
        ...
        <div className="space-y-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-ink">Medium</label>
            <select
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-ink">Price Range</label>
